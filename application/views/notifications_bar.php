...
<?php foreach ($notificaciones as $notificacion) { ?>
    <li>
        <a target='_blank' href="<?=$notificacion->url?>">
            <div title='<?=$notificacion->descripcion?>'>
                <i class="fa fa-comment fa-fw"></i> <?=$notificacion->titulo?>
                <span class="pull-right text-muted small"><?=$notificacion->fecha?></span>
            </div>
        </a>
    </li>
                    <li class="divider"></li>
