...
(function ($) {
    ...
    Datagrid.prototype.browserSupportsLocalStorage = function() {
        var mod = 'modernizr';
        try {
    ...
    Datagrid.prototype.setLocalStorageItem = function (item, value) {

    };

    //By default this is empty as some browsers doesn't support localStorage cache
    Datagrid.prototype.removeLocalStorageItem = function (item) {

    };

    //By default this is empty as some browsers doesn't support localStorage cache
    Datagrid.prototype.getLocalStorageItem = function (item) {
        return null;
    };

    Datagrid.prototype.setLocalStorageCache = function () {
    ...
    Datagrid.prototype.checkCachedData = function () {
        ...
        var cachedDatra = this.getLocalStorageItem('gcrud_' + unique_hash);
        ...
        try {
            ...
            this.removeLocalStorageItem('gcrud_' + unique_hash);
            return false;
        }
    ...
    Datagrid.prototype.SearchAndOrderingTrigger = function () {
        ...
        datagrid_object.setLocalStorageItem('gcrud_' + unique_hash , JSON.stringify(data_to_send));
