...
<% if (preferencias.show_observador) { %>
...
<% if (preferencias.show_empresas_propuestas) { %>
<!-- empresas postuladas -->
<div class="row">
	<div class="span12">
...
<% if (preferencias.show_documentos_solicitados) { %>
	<% if (_.size(datos_pedidos) > 0) { %> 
	<div class="row">
		<div class="span12">
		    <h3>Documentos pedidos por el gobierno</h3>
		    <p>Al iniciar el proceso el Gobierno define que documentos solicitará liberar
		     a las empresas participantes. <br />Estos fueron los documentos solicitados:</p>
		     <ul> 
...
<div class="row">
	<div class="span12">
		<h3><%= preferencias.documentos_liberados_titulo %></h3>
...
<% if (preferencias.show_eventos_licitacion) { %>
<div class="row">
	<div class="span12">
